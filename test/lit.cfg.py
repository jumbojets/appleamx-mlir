...
config.test_exec_root = os.path.join(config.appleamx_obj_root, "test")
...
tool_dirs = [config.appleamx_tools_dir, config.llvm_tools_dir]
tools = [
    "mlir-opt",
    "appleamx-opt",
    "appleamx-translate",
...
llvm_config.with_environment(
    "PYTHONPATH",
    [
        os.path.join(config.mlir_obj_dir, "python_packages", "appleamx"),
    ],
    append_path=True,
)
